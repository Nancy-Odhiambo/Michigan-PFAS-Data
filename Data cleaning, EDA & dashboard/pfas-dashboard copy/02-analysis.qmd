...
p <- county_hazard |>
  ...
  coord_flip() +
  labs(
    title = "Public Water Locations with Hazard Index > 1 by County",
    x = "County",
...
## Hazard Index Distribution in Michigan
### Combined Analysis
## PFAS sites by Type and Hazard Index
```{r}
...
# Define color palette for Hazard_Index
