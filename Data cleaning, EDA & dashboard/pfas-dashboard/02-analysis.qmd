...
# Create stacked bar plot with analyte contributions
p_decomposition <- ggplot(
  ...
  aes(
    ...
    text = paste(
      "<br>Analyte:", analyte,
      "<br>Contribution:", round(total_hazard_analyte, 2)
    )
  )
) +
  geom_col(width = 0.7, position = "stack") +
  geom_text(
    aes(label = round(total_hazard_analyte, 1)),
    position = position_stack(vjust = 0.5),
    size = 3
  ) +
  scale_fill_viridis_d(option = "plasma", end = 0.9) +  # color-blind friendly
  labs(
